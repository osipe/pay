...
//    }
    ...
    public void testSchedulePay() throws InterruptedException {
        ...
        billIds.add(1L);
        PayService.pay(acc.getId(), billIds);
        System.out.println("========PAY Bill Id {1} again=============");
        PayService.pay(acc.getId(), billIds);
        System.out.println("========PAY Bill Id {10}=============");
        Set<Long> billIds_10 = new HashSet<>();
        billIds_10.add(10L);
        PayService.pay(acc.getId(), billIds_10);
        System.out.println("PAY Bill Id {2,3} : ");
        Set<Long> billIds_23 = new HashSet<>();
        billIds_23.add(2L);
        billIds_23.add(3L);
        PayService.pay(acc.getId(), billIds_23);
